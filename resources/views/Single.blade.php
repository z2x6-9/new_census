...
<body style="    margin: 10% 31%; width: 69%;">
    <form class="w-full max-w-lg" method="POST" action="{{ route('single.store') }}">
        @csrf
        <div class="flex flex-wrap -mx-3 mb-6">
            <div style="margin-left:25%;" class="w-full md:w-1/2 px-3">
                ...
                <input
                    ...
                    id="Person" name="Person"  type="text" placeholder="ألاسم">
            </div>
        </div>
        <div class="flex flex-wrap -mx-3 mb-6">
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            ...
            <button type="submit" class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                <svg style="color: white;" class="w-6 h-6 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
