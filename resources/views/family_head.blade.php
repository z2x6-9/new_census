            ...
            <div class="col-md-8 offset-md-2">
                ...
                <form method="POST" action="{{ route('famile.store') }}">
                    ...
                    <div class="form-floating">
                        <input type="text" name="Leader" class="form-control mb-3" id="floatingInput"
                    ...
                    <div class="form-floating">
                        <input type="date" name="Date_Of_Birth" class="form-control mb-3" id="floatingInput" placeholder="تاريخ الميلاد"
                            required>
                    ...
                    <div class="form-floating">
                        <input type="text" name="Living" class="form-control mb-3" id="Living" placeholder="تاريخ الميلاد"
                            required>
                    ...
                    <div class="form-floating">
                        <input type="number" name="Phone_Number" inputmode="numeric" class="form-control mb-3" id="floatingInput"
